...
cd /usr/bin
wget https://raw.githubusercontent.com/Daffastorevps/vvip/master/bot/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
clear
wget https://raw.githubusercontent.com/Daffastorevps/vvip/master/bot/fvstore.zip
unzip fvstore.zip
